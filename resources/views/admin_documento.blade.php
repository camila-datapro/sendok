                                            ...
                                            <?php                  
                                                   for($i=0;$i<sizeOf($propuestas);$i++){
                                                      ...
                                                      <td>
                                                         ...
                                                         <button class='btn btn-success' id='enviar_".$propuestas[$i]->id_propuesta."'>
  ...
  <div class="modal fade" id="modal_editar_propuesta" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar proceso</button>
          <button type="button" class="btn btn-primary" data-dismiss="modal">Generar vista previa</button>
        </div>
      </div>
    </div>
  </div>
