    ...
    public function __construct()
{
  ...
  /**
     ...
     * @bodyParam request array datos de producto obtenidos por formulario.
     * @group ProductoController
     ...
     * @bodyParam request array datos de productos obtenidos por formulario.
     * @group ProductoController
     * @return array array resultado exitoso o null en caso de error
     */
     ...
     * @bodyParam request array con identificador unico de producto
     * @group ProductoController
     * @return array array resultado exitoso o null en caso de error
     */
     ...
     * @bodyParam request array con identificador unico de producto
     * @group ProductoController
     * @return array array Array con datos de producto
     */
     ...
     * @group ProductoController
     * @return array array Array con listado de productos
     */
     ...
     * @group ProductoController
     * @bodyParam array array Array que contiene filtros ingresados por el usuario.
     * @return array array Array con listado de productos
     */
     ...
     * @bodyParam array array Array con datos de producto a actualizar
     * @group ProductoController
