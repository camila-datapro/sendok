...
CREATE TABLE `cliente_destino` (
  ...
  `fono_cliente` int(15) UNSIGNED,
  `id_comuna_cliente` int(2) UNSIGNED,
  `id_region_cliente` int(2) UNSIGNED,
  `email_cliente` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `direccion_cliente` varchar(255) COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `ejecutivo_venta`; 
...
CREATE TABLE `ejecutivo_venta` (
  ...
  `fono_ejecutivo` int(15) UNSIGNED,
  `rut_empresa` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_comuna_ejecutivo` int(2) UNSIGNED,
  `id_region_ejecutivo` int(2) UNSIGNED,
  `email_ejecutivo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `direccion_ejecutivo` varchar(255) COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tipo_empresa` (
  ...
  `descripcion_tipo` varchar(255) COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `empresa_origen`; 
...
CREATE TABLE `empresa_origen` (
  ...
  `fono_empresa` int(15) UNSIGNED,
  `id_comuna_empresa` int(2) UNSIGNED,
  `id_region_empresa` int(2) UNSIGNED,
  `id_tipo_empresa` int(2) UNSIGNED,  
  `direccion_empresa` varchar(255) COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `producto` (
  ...
  `descripcion_producto` varchar(255) COLLATE utf8mb4_unicode_ci,
  `id_tipo_producto` bigint(20) UNSIGNED
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `servicio` (
  ...
  `descripcion_servicio` varchar(255) COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `comuna` (`id`,`comuna`,`provincia_id`)
VALUES
	(1,'Arica',1),
	(2,'Camarones',1),
	(3,'General Lagos',2),
...
INSERT INTO `provincia` (`id`,`provincia`,`region_id`)
VALUES
	(1,'Arica',1),
	(2,'Parinacota',1),
	(3,'Iquique',2),
...
INSERT INTO `region` (`id`,`region`,`abreviatura`,`capital`)
VALUES
